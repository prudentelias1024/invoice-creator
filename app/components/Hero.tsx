  ...
  return (
       <div className="call_up_text lg:pl-[7em] flex flex-col lg:w-full  pt-[1.5em] gap-[1em]">
           ...
           <div className='flex gap-[3em] m-auto lg:pt-[1em]'>
            <button className='bg-white-500 lg:w-[12em] border -ml-[4em] text-black p-[.6em] rounded-md'>Try it for free</button> 
            <button className='bg-purple-500 lg:w-[12em]  text-white p-[.6em] rounded-md'>Login</button> 
            </div> 
        </div>
  )
}
