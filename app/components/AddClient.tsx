...
<div className='flex flex-col  ml-[1em]'>
        ...
        <label htmlFor="fullname" className="text-sm  font-semibold">Full Name</label>
          <input ref={fullnameRef} className="w-[90%] lg:w-full  mt-[.5em]  h-[2em] border p-4  font-normal border-[#ccc] rounded-md text-[#18181b]"   type="text" name="fullname" placeholder='Type here'/>
...
<div className='flex flex-col  ml-[1em]'>
        ...
        <label htmlFor="email" className="text-sm  font-semibold">Email</label>
          <input ref={emailRef} className="w-[90%] lg:w-full  mt-[.5em]  h-[2em] border p-4  font-normal border-[#ccc] rounded-md text-[#18181b]"   type="text" name="email" placeholder='Type here'/>
...
<div className='flex flex-col  ml-[1em]'>
        ...
        <label htmlFor="email" className="text-sm  font-semibold">Title</label>
          <input ref={titleRef} className="w-[90%] lg:w-full  mt-[.5em]  h-[2em] border p-4  font-normal border-[#ccc] rounded-md text-[#18181b]"   type="text" name="title" placeholder='Type here'/>
...
<div className='flex flex-col  ml-[1em]'>
        ...
        <label htmlFor="email" className="text-sm  font-semibold">Phone Number</label>
          <input ref={phonenoRef} className="w-[90%] lg:w-full  mt-[.5em]  h-[2em] border p-4  font-normal border-[#ccc] rounded-md text-[#18181b]"   type="text" name="email" placeholder='Type here'/>
...
<div className='flex flex-col mt-[2em] ml-[1em]'>
        ...
        <label htmlFor="email" className="text-sm  font-semibold">Address</label>
          <input ref={addressRef} className="w-[90%] lg:w-full  mt-[.5em]  h-[2em] border p-4  font-normal border-[#ccc] rounded-md text-[#18181b]"   type="text" name="address" placeholder='Type here'/>
