...
const doc = new jsPDF();
 // --- HEADER ---
  doc.setFontSize(20);
  doc.text("Invoicely Report", 14, 20);

  doc.setFontSize(10);
  doc.text("Generated by Invoicely", 14, 28);
 ...
 useEffect(() => {
  ...
  return (
   ...
   <button onClick={previewPDF}  className=' text-white w-[7em] lg:w-[10em] p-[.5em] rounded-md h-fit mt-[1em] bg-yellow-500  '>Preview </button> 
